...
class SearchController extends Controller
{
  public function searchAction(Request $request)
  {
    ...
    return $this->render('@AdimeoDataSuiteSearchClient/Default/search.html.twig', [
      'facets' => $facets,
      'sortingOptions' => isset($sortingOptions) ? $sortingOptions : [],
  ...
  public function moreLikeThisAction(Request $request){
    ...
    if($response->getStatusCode() == 200){
      ...
      foreach($data as $result){
        $html .= '<div class="more-like-this-item">' . $this->renderView('@AdimeoDataSuiteSearchClient/Default/result-item.html.twig', [
          'result' => $result,
          'searchParams' => $searchParams
            ]) . '</div>';
      }
